/**
 * Creates a pre-populated public domain sample EPUB book object (Alice in Wonderland)
 */
export function createSampleEpub() {
  const sampleId = 'book_sample_' + Date.now();
  ...
  const chapters = [
    ...
    },
    {
      ...
      content: `
        ...
        <p><em>ALICE’S RIGHT FOOT, ESQ.<br/>HEARTHRUG,<br/>NEAR THE FENDER,<br/>(WITH ALICE’S LOVE).</em></p>
    ...
    },
    {
      ...
      content: `
        ...
        <p>“Sit down, all of you, and listen to me! I’ll soon make you dry enough!” said the Mouse with an important air. They all sat down at once, in a large ring, with the Mouse in the middle.</p>
      `
    }
  ];
  ...
  return {
    ...
    language: "en",
    description: "Classic fantasy novel about a girl named Alice falling through a rabbit hole into a fantasy world.",
